...
#SBATCH -o /home/nandy.15/Research/Experiments_DAIF/GMM/Slurm_Scripts/vary_n/Output_Messages/slurm_out_%A_%a_%x_%j_%t.out
#SBATCH -e /home/nandy.15/Research/Experiments_DAIF/GMM/Slurm_Scripts/vary_n/Error_Messages/slurm_err_%A_%a_%x_%j_%t.err
...
"$CONDA_PREFIX/bin/python" \
  "/home/nandy.15/Research/Experiments_DAIF/GMM/Python_Scripts/vary_n.py" \
  "$n" "$seed"
